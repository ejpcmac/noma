//! The build script for noma-hello-fw.
...
#[expect(
    clippy::unwrap_used,
    reason = "any of the following errors is a hard error"
)]
fn copy_linker_script() {
    #[cfg(not(any(feature = "feather-nrf52840", feature = "nucleo-l476rg")))]
    let memory = &[];
    #[cfg(feature = "feather-nrf52840")]
    let memory = include_bytes!("memory/nrf52840.x");
    #[cfg(feature = "nucleo-l476rg")]
    let memory = include_bytes!("memory/stm32l476rg.x");
